...
echo '<!DOCTYPE html><head><meta charset="utf-8"><title>Compact Pathfinder Stat Blocks</title><style>body{font-size:9pt;}.symbol{font-family: "Segoe UI Symbol";}h2{display:block;font-size:1em;margin:0em;font-weight:bold;text-decoration:underline;}p{margin-top:0em;}blockquote(margin-top:0em;margin-bottom:0em;}</style></head><body>' > $HTM_TEMP
